// Transcrypt'ed from Python, 2019-08-12 15:16:02
...
export var ProfilePlotCanvas =  __class__ ('ProfilePlotCanvas', [object], {
	...
	get _make_plot () {return __get__ (this, function (self) {
		...
		data.append (dict ({'type': 'scatter', 'mode': 'markers', 'showlegend': false, 'x': results_x, 'y': results_y, 'name': null, 'marker': dict ({'opacity': 0.5, 'size': 2})}));
		fig.data = data;
		fig.layout.title = dict ({'text': 'Stacked Subplots with Shared X-Axes'});
		...
		fig.layout.xaxis = dict ({'title': dict ({'text': 'Concentration'}), 'position': 0.465, 'showline': true, 'linecolor': 'black', 'ticks': 'inside', 'tickwidth': 1, 'tickcolor': 'black', 'ticklen': 4});
