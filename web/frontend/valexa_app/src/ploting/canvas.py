...
class ProfilePlot:
    ...
    def _make_plot(self):
        ...
        data.append({
            "type": "scatter",
            "x": levels_x,
            "y": [l.recovery for l in p.levels],
            "name": "Recovery",
            "line": {"color":"purple"},
        })
        data.append({
            ...
            "mode": "lines",
            "x": levels_x,
            "y": [l.rel_tolerance[0] for l in p.levels],
            "name": "Min tolerance limit",
        ...
        data.append({
            ...
            "mode": "lines",
            "x": levels_x,
            "y": [l.rel_tolerance[1] for l in p.levels],
            "name": "Max tolerance limit",
        ...
        data.append({
            ...
            "mode": "lines",
            "x": levels_x,
            "y": [p.acceptance_interval[0] for _ in p.levels],
        ...
        data.append({
            ...
            "showlegend": False,
            "x": levels_x,
            "y": [p.acceptance_interval[1] for _ in p.levels],
            "name": "Acceptance limit",
            "line": {"dash":"dash"},
            "marker": {"color": "black"},
        })
...
class ProfileLinearity:
    ...
    def _make_plot(self):
        ...
        levels_x = [l.introduced_concentration for l in p.levels]
        ...
        data.append({
            "type": "scatter",
            "x": levels_x,
            "y": [l.calculated_concentration for l in p.levels],
            "name": "line y=x",
            "line": {"color":"purple"},
        })
        data.append({
            ...
            "mode": "lines",
            "x": levels_x,
            "y": [l.abs_tolerance[0] for l in p.levels],
            "name": "Min tolerance limit",
            "line": {"color":"blue", "width": 1},
        })
        data.append({
            ...
            "mode": "lines",
            "x": levels_x,
            "y": [l.abs_tolerance[1] for l in p.levels],
            "name": "Max tolerance limit",
            "line":  {"color":"green", "width": 1},
        })
        data.append({
        ...
        results_x = [s.concentration for s in p.series]
        results_y = [s.result for s in p.series]
        ...
        fig.layout.yaxis = {
            "title": {"text": "Calculated Concentration"},
            "rangemode": "tozero",
            "showline": True,
            "linecolor": "black",
            "ticks": "inside", 
